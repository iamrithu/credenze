...
//
//     final serviceTaskModel = serviceTaskModelFromJson(jsonString);

import 'dart:convert';

ServiceTaskModel serviceTaskModelFromJson(String str) =>
    ServiceTaskModel.fromJson(json.decode(str));

String serviceTaskModelToJson(ServiceTaskModel data) =>
